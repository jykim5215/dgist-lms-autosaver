...
# 마스코트 붕어빵 톤: 진한 먹선 + 노란 몸통 (참고 이미지 기준)
BG = (250, 246, 236, 255)      # 아주 옅은 크림 바탕
BODY = (247, 190, 60, 255)     # 노란 몸통
BODY_HI = (252, 216, 130, 255) # 윗면 하이라이트
LINE = (43, 40, 38, 255)       # 굵은 먹색 윤곽선
SCORE = (43, 40, 38, 120)      # 표면 결
OUTLINE_W = 1.5                # 윤곽선 두께 (24 그리드 기준)
...
# 붕어빵답게 통통한 몸통 (마스코트처럼 더 둥글게)
BODY_PATH = _path((2.1, 12.0), [
    ("C", (2.1, 8.4), (5.2, 5.8), (9.9, 5.8)),
    ("C", (13.8, 5.8), (16.7, 8.1), (17.9, 10.7)),
    ("C", (18.2, 11.3), (18.2, 12.7), (17.9, 13.3)),
    ("C", (16.7, 15.9), (13.8, 18.2), (9.9, 18.2)),
    ("C", (5.2, 18.2), (2.1, 15.6), (2.1, 12.0)),
])
...
def render(size: int, ss: int = 8, inset: float = 0.86, radius_ratio: float = 0.25,
    ...
    def shape(pts, fill, w=OUTLINE_W):
